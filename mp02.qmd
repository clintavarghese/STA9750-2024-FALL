...
This project aims to find new movie ideas by analyzing data from [the IMDb
non-commercial release](https://datasets.imdbws.com/). By looking at what made past movies successful, identifying top actors and directors,popular genres.. we hope to give Hollywood executives useful insights for creating movies that can draw audiences back to theaters.
