---
title: "Do traffic calming projects generate rising real estate values in NYC?"
...
![](images/thesis.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/t-test-11-13.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}

<br/>

This is evident in the following ridge plot, with Prospect Park West leading other corridors in Park Slope:  

![](images/immediate-demand-2011-2013.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}

<br/>

This map visualization, highlights the dominance of green on Prospect Park West compared to its neighboring streets: 

![](images/after-installation-green.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
**5th Avenue, Park Slope 2011-2023**: 


![](images/b.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}

<br/>

![](images/after.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/ridgeplot-11-19.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/ridgeplot-13-19.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}

<br/>

The pre-Covid `2010`'s truly represented a period of healthy valuations of Park Slope real estate:

![](images/after-financial-crisis-peak-brooklyn.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/demand-2011-2019.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/after-covid.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/resilency.jpg ){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
...
![](images/gentrification.jpg){style="width:80%; box-shadow: -1px 1px 2px rgba(0, 0, 0, 0.5); display: block; margin: auto;"}
